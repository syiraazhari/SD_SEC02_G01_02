  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="homepagepatient.php"><img src="assets/img/gallery/logo.png" width="118" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
			  ...
			  <li class="nav-item px-2"><a class="nav-link" href="../../admin_doctor/public/doctor/doctorList.php">Doctors</a></li>
			  <li class="nav-item px-2"><a class="nav-link" href="./viewappointmenthistory.html">History</a></li>
              <li class="nav-item px-2"><a class="nav-link" href="./appointmentbookpatient.html">Book Appointment</a></li>
            ...
            </ul><a class="btn btn-sm btn-outline-primary rounded-pill order-1 order-lg-0 ms-lg-4" href="./SignOut.php">Sign Out</a>
          </div>
        </div>
      </nav>
        ...
        <div class="container">
          ...
          echo '<h1 class="fw-light font-base fs-6 fs-xxl-7">Hello <strong> '.$_SESSION['name'].' </strong>'
              ...
              <p class="fs-1 mb-5">How are you doing today? <br />Take a look for your next appointment </p>
				...
				<br>
				<p class="fs-1 mb-5">Minimum deposit is €200. Please refer front desk for further payment. </p>
				<br>
				<div class="d-grid">
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow">
                          <div class="card-body d-flex flex-column flex-center py-5"><img src="assets/img/gallery/anita.png" width="128" alt="..." />
                            <h5 class="mt-3">Finn Müller</h5>
                            <p class="mb-0 fs-xxl-1">Cardiologist, European Society of Cardiology</p>
                            <p class="text-600 mb-0">Dortmund, Germany</p>
                      ...
                      <div class="col-md-4 mb-8 mb-md-0">
                        <div class="card card-span h-100 shadow">
                          <div class="card-body d-flex flex-column flex-center py-5"><img src="assets/img/gallery/leo-mario.png" width="128" alt="..." />
                            <h5 class="mt-3">Cameron LastName</h5>
